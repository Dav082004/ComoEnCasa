...
- `detalle_pedido`: se agregan los productos vinculados al pedido.

**Relaciones:**

- `pedido.usuario_id` ← `$usuarioId`
- `detalle_pedido.pedido_id` ← ID generado de `pedido`
- `detalle_pedido.producto_id` ← IDs de los productos del array `$productos`
