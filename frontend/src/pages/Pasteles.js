...
import torta1 from "./img/tortas/torta_1.webp";
import torta2 from "./img/tortas/torta_2.webp";
import torta3 from "./img/tortas/torta_3.webp";
import torta4 from "./img/tortas/torta_4.webp";
    ...
    <div className="container">
      ...
      <div className="content">
        <div className="text-center">
          <img src={bannerTortas} alt="Banner Tortas" />
        </div>
      ...
      <footer className="text-center">
        <p>Derechos reservados Como en Casa | 2025 | Perú</p>
      </footer>
